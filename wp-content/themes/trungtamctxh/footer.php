                ...
                <div class="copyright container">
                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <address>
							  ...
							  <abbr title="Phone">Điện thoại:</abbr>0650 3 833 580<br>
							  <abbr title="Website">Website:</abbr> <a href="http://congtacsinhvien.tdmu.edu.vn" alt="congtacsinhvien.tdmu.edu.vn">congtacsinhvien.tdmu.edu.vn</a>
						</address>
                    </div>
                </div>
        </footer>
...
<script type="text/javascript">
	$(document).ready(function () {
		   ...
		   $(".widget_text").removeClass("widget");
		   $(".textwidget").replaceWith("");
		   $(".widget_text").addClass("list-group-item wrap-lst-grp-item");
